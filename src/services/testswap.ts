...
async function routeSwap() {
    ...
    const [inputMint, outputMint] = [new PublicKey("3NQLBRbD8Ymms2KyRfzey1vRaHYPfQipexR36FvwLH4V"), new PublicKey("Wos9Qe9vtkxgDyvvq8fdryLDKhVPsAF24yP9P7DfXK4")]
    const [inputMintStr, outputMintStr] = ["3NQLBRbD8Ymms2KyRfzey1vRaHYPfQipexR36FvwLH4V", "Wos9Qe9vtkxgDyvvq8fdryLDKhVPsAF24yP9P7DfXK4"]
