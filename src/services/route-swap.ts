...
export async function routeSwap() {
    ...
    const [inputMint, outputMint] = [new PublicKey("AXqZ15xC8kz7GAqMAZv8Cg9YU5Qzvh7wjS5jeYKYSZwV"), new PublicKey("2aCaeZAH4792hZWcFoqrWWoK1Xk2s7oWTAXQThxBLXG8")]
    const [inputMintStr, outputMintStr] = ["AXqZ15xC8kz7GAqMAZv8Cg9YU5Qzvh7wjS5jeYKYSZwV", "2aCaeZAH4792hZWcFoqrWWoK1Xk2s7oWTAXQThxBLXG8"]
    ...
    console.log(targetRoute.executionPrice?.toNumber());
